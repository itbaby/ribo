    ...
    <main bind:this={sliderContainer} class="relative w-full h-[400px] sm:h-[380px] md:h-[360px]">
        ...
        <article class="slide absolute inset-0 flex flex-col justify-between p-6 md:p-8 bg-white rounded-2xl border border-stone-200">
            <div>
                <blockquote class="text-sm md:text-base text-stone-600 mb-4 md:mb-6 leading-relaxed">
                    "睿柏与日本百年材料企业 MYK 株式会社正式签署战略协议，双方将在淮北共建零碳联合实验室，利用 MYK 世界领先的低能耗聚合技术，把睿柏高纯电子级溶剂产品碳排放削减 40 % 以上，并面向全球新能源汽车及半导体客户推出可循环包装树脂，首批订单已进入日产与特斯拉供应链，标志着中国绿色高端化工材料首次大规模反向输出日本核心市场。"
                </blockquote>
            </div>
            <div class="flex items-center mt-6 pt-4 border-t border-stone-200">
                ...
                <div>
                    <p class="font-semibold text-stone-800 text-sm">睿柏与日本MYK达成合作</p>
                    <p class="text-xs text-stone-500">发布于: 2025-08-02 9:32</p>
                </div>
            </div>
        </article>
        ...
        <article class="slide absolute inset-0 flex flex-col justify-between p-6 md:p-8 bg-white rounded-2xl border border-stone-200">
            ...
            <div class="flex items-center mt-6 pt-4 border-t border-stone-200">
                ...
                <div>
                    <p class="font-semibold text-stone-800 text-sm">睿柏与FIL人力外包服务</p>
                    <p class="text-xs text-stone-500">发布于: 2025-06-12 9:32</p>
                </div>
            </div>
        </article>
        ...
        <article class="slide absolute inset-0 flex flex-col justify-between p-6 md:p-8 bg-white rounded-2xl border border-stone-200">
            ...
            <div class="flex items-center mt-6 pt-4 border-t border-stone-200">
                ...
                <div>
                    <p class="font-semibold text-stone-800 text-sm">睿柏与Alibaba技术分享会</p>
                    <p class="text-xs text-stone-500">发布于: 2025-06-12 9:32</p>
                </div>
            </div>
        </article>
